...
#define STRING_CONFIG_H_AUTHOR "(Clayblock, MKS Robin Nano V1.1 - STOCK - BLTOUCH)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 23.20
  #define DEFAULT_bedKi  4.03
  #define DEFAULT_bedKd 89.11
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 40, -30, -3.2 }
