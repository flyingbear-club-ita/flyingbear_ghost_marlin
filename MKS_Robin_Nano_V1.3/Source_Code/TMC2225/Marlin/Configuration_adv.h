...
//
  ...
  #define TEMP_COOLER_PIN          7  // Laser/Cooler temperature sensor pin. ADC is required.
  #define COOLER_FAN                  // Enable a fan on the cooler, Fan# 0,1,2,3 etc.
  #define COOLER_FAN_INDEX         5  // FAN number 0, 1, 2 etc. e.g.
  #if ENABLED(COOLER_FAN)
    #define COOLER_FAN_BASE       94  // Base Cooler fan PWM (0-255); turns on when Cooler temperature is above the target
...
//#define CUSTOM_MENU_MAIN
  ...
  //#define CUSTOM_MENU_MAIN_TITLE "Preriscalda"
  ...
  #define MAIN_MENU_ITEM_1_DESC "Info"
  #define MAIN_MENU_ITEM_1_GCODE "M503"
